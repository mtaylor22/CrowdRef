...
// Populates the bitarry values according to a string of the form "0101010100111100," etc.
BitArray.prototype.fromString = function(str){
  for (var index = 0; index < str.length && index < this.size; index++){
    this.set(index, (str[index] == '1') ? 1 : 0);
  }
}